...
public class Product implements Serializable {
    ...
    public void setQuantity(int quantity) {
        this.quantity = quantity;
        // Automatically update the status based on inventory stock quantity
    ...
    // Displays product details for simple printing
    public void display() {
        System.out.println("ID: " + productId + " | Name: " + productName + " | Category: " + category + " | Price: $" + price + " | Qty: " + quantity + " | Status: " + productStatus);
    }
}
